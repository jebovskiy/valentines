...
const KNOW_ME_PERSONAL = [
  ...
  { text: 'Какой наш общий мечта ты хочешь осуществить сначала?', options: ['🌍 Путешествие вокруг света', '🏠 Собственный дом', '👨‍👩‍👧‍👦 Большая семья', '💰 Финансовая независимость'] },
  { text: 'Как ты видим наше будущее через 5 лет?', options: ['👨‍👩‍👧‍👦 С детьми', '🌍 Постоянные путешествия', '🏢 Карьерный рост', '🏡 Уютный дом'] },
];
...
const CHOOSE_ONE_PAIRS = [
  ...
  { text: 'Варьировать маршрут или идтиตรой путь?', options: ['🛤️ Новый путь', '🛣️ Привычный путь'] },
